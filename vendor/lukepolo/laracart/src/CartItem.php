...
class CartItem
{
     ...
     * @return string
     */
    public function subTotal($format = false, $withDiscount = true, $taxedItemsOnly = false, $withTax = false)
    {
     ...
     * @return string
     */
    public function netTotal($format = false)
    {
        return LaraCart::formatMoney(
     ...
     * @return string
     */
    public function subItemsTotal($format = false, $taxedItemsOnly = false, $withTax = false)
    {
        $total = 0;
