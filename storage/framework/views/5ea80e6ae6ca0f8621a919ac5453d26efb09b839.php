	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST" action="<?php echo e(url('/login-check')); ?>">
...
<?php /**PATH C:\xampp\htdocs\ecomerce_laravel2\resources\views/pages/login.blade.php ENDPATH**/ ?>