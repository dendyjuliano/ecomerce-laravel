    ...
    <div class="container">
      <div class="row mb-5">
        <div class="col-md-6">
          <div class="block-16">
            <figure>
              <img src="<?php echo e(URL::to('frontend/images/blog_1.jpg')); ?>" alt="Image placeholder" class="img-fluid rounded">
          ...
          <div class="block-38 text-center">
            <div class="block-38-img">
              <div class="block-30-header">
                <img src="<?php echo e(URL::to('frontend/images/mee2.jpeg')); ?>" width="300" alt="Image placeholder" class="mb-4">
...
<?php echo $__env->make('template1.template1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecomerce_laravel2\resources\views/pages/home/aboutPage.blade.php ENDPATH**/ ?>